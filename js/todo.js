...
//	接触其实位置
	...
	if(localStorage.todos){
		...
		for(var i=0;i<todos.length;i++){
			...
			$('<li class=""+c+""><div class="ding"><img src="images/dd.png" alt="" /></div><div class="content"><div class="text">'+todos[i].name+'</div></div><div class="delete"><img src="images/del.png" alt="" /></div><div class="state"><a href="javascript:;">x</a></div></li>').appendTo(ul);
		}
	...
	add.on("touchend",function(){
		...
		todos.push(todo);
		localStorage.todos=JSON.stringify(todos)
		$('<li><div class="ding"><img src="images/dd.png" alt="" /></div><div class="content"><div class="text">'+v+'</div></div><div class="delete"><img src="images/del.png" alt="" /></div><div class="state"><a href="javascript:;">x</a></div></li>').appendTo(ul);
		input.val('').focus();		
	})
...
//	})
	...
	var setr=$("#header .set");
	var floor=$("#floor");
	setr.on("click",function(){
		floor.toggleClass("floor");
	})
